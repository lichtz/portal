...
public class Constants {
    ...
    public static final String BASE_PACKAGE = "com.licht.router_annotation";
    public static final String ROUTE_GROUP_INTERFACE =Constants.BASE_PACKAGE+".interfaces.RouterLoadGroup";
